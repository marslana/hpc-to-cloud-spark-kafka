# Artifact: Performance Characterization of Kafka-Spark Streaming Integration on HPC Infrastructure

**Authors:** Muhammad Arslan Tariq, Grégoire Danoy, Pascal Bouvry
**Affiliation:** SnT / FSTM-DCS, University of Luxembourg

---

## Overview

This artifact contains all scripts, raw data, and instructions needed to reproduce the experiments presented in *"Performance Characterization of Kafka-Spark Streaming Integration on HPC Infrastructure"*. The experiments benchmark Apache Kafka and Apache Spark Structured Streaming deployed via Singularity containers on HPC infrastructure managed by SLURM.
...
```bibtex
@inproceedings{tariq2026kafka,
  title={Performance Characterization of Kafka-Spark Streaming Integration on HPC Infrastructure},
  author={Tariq, Muhammad Arslan and Danoy, Gr{\'e}goire and Bouvry, Pascal},
  booktitle={Proc. IEEE/ACM ...},
  year={2026}
}
```
