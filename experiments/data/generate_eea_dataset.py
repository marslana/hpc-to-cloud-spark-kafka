...
Records are ~120 bytes each in CSV.
  1 GB ≈  8.3M records
 10 GB ≈ 83M records

Usage:
  python3 generate_eea_dataset.py --output /path/to/output.csv --size-gb 1
  python3 generate_eea_dataset.py --output /path/to/output.csv --size-gb 10
"""
...
# Weight countries so FILTER_COUNTRIES get ~10% combined
# LU ~2%, DE ~5%, BE ~3% = 10%; other 7 countries share 90%
COUNTRY_WEIGHTS = {
    "LU": 2, "DE": 5, "BE": 3,
